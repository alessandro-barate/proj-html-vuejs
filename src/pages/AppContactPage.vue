      ...
      faqs: [
        {
          ...
          answer:
            "Quisque ultricies enim ac lacus feugiat mattis. In et ipsum sed tellus interdum mattis sit amet id mi. Phasellus nec eros in felis blandit cursus. Nulla facilisi. Nam in purus elit. Aenean tempor volutpat ante.",
        },
  ...
  <section>
    <div class="container form-contacts">
      <div class="row bg-lightpink">
          ...
          <div class="form-container p-4">
            ...
            <form>
              <div class="mb-4">
                ...
                <input
                  type="text"
                  class="form-control p-tb-12 border-radius-10"
              ...
              <div class="mb-4">
                <label for="exampleInputNumber1" class="form-label"
                  >NUMBER</label
                >
                <input
                  type="number"
        ...
        <img
          src="../../public/img/footer/shape-bottom.png"
          class="bg-lightpink p-0"
          alt=""
        />
      </div>
